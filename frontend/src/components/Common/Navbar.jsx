...
import { Film, Search, User, LogOut, Ticket, LayoutDashboard, Menu, X, Sun, Moon } from 'lucide-react';
      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg border border-gray-700 text-gray-300 hover:text-white hover:bg-dark-card transition"
            ...
            >
              <div className="py-4 space-y-2">
                <div className="px-4">
                  <button
                    onClick={toggleTheme}
                    className="w-full flex items-center justify-between px-3 py-2 rounded-lg border border-gray-700 text-gray-300 hover:bg-dark-card transition"
                  >
                    <span>Theme</span>
                    {theme === "dark" ? <Sun className="w-5 h-5" /> : <Moon className="w-5 h-5" />}
                  </button>
